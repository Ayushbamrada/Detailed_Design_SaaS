...
// import { hideSnackbar } from "../notifications/notificationSlice";
...
//         >
//           <div className={`px-6 py-4 rounded-2xl shadow-2xl border flex items-center gap-3 min-w-[300px] max-w-md ${getBgColor()}`}>
//             {getIcon()}
